  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="hidden xl:flex absolute bottom-0 -left-[10000px]"
      >
        <Avatar />
      </motion.div>
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            I am student at St. Joseph’s College of Engineering, with a strong CGPA of 8.39, skilled in Full Stack Development, UI/UX Design, Logo Designing, and Data Analysis. I’m passionate about creating intuitive digital solutions and continuously exploring new technologies to grow as a developer and designer
          </motion.p>
